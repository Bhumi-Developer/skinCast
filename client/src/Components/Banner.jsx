...
//   // Simple flow: 1,2,3,4,5,6,5,4,3,2,1 and repeat
//   const banners = useMemo(() => {
//     const forward = [...originalBanners];
//     const backward = [...originalBanners].reverse().slice(1, -1);
...
//               >
//                 {/* Left side - Same background as original */}
...
//                   {/* <button className="bg-[#B77466] hover:bg-[#957C62] text-white font-semibold py-2.5 md:py-3 px-6 md:px-8 rounded-xl transition duration-200 shadow-md hover:shadow-lg w-full sm:w-auto text-center flex items-center justify-center gap-2 text-sm md:text-base">
//                     Start-Analysis
...
// <button  onClick={() => setShowFormPopup(true)}
