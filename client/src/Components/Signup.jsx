    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="absolute -top-20 -right-20 h-40 w-40 rounded-full bg-gradient-to-br from-primary/20 to-primary-middle/20 blur-3xl" />
                <div className="absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-gradient-to-tr from-primary-dull/20 to-primary-light/20 blur-3xl" />

                <div className="relative space-y-6">
                    {/* Header */}
                    <div className="text-center">
                        <h2 className="text-3xl font-bold tracking-tight text-gray-800">
                            <span className="bg-gradient-to-r from-primary to-primary-middle bg-clip-text text-transparent">
                                Glow
                            </span>
                    ...
                    >
                        <span className="relative z-10">
                            {state === "register" ? "Get Started" : "Sign In"}
                        </span>
                        <div className="absolute inset-0 -z-0 bg-gradient-to-r from-primary-middle to-primary opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                    </button>
